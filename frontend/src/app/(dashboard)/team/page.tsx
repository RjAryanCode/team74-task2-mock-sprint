    ...
    <div className="TeamMemberBox">
      ...
      <div className="space-y-4 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div>
          ...
          <p className="text-xs font-medium tracking-wide text-zinc-400">Developer</p>
          <p className ="FontSize10">I&apos;m learning a 3rd year bachelor of IT student who majoring in Cyber Security, I rockclimbing as well as webpage editing. I wish to learn more about cyber security so I can be someone who can keep up with evolving theats so I can stay protected and keep others protected.</p>
        </div>
       </div>
      </div>
      </div>
